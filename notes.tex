...
\begin{theorem}
  If $\pc, \rho_1 |- e \Downarrow a_1$ and
  $\pc, \rho_2 |- e \Downarrow a_2$ and
...
\begin{proof}\renewcommand{\qedsymbol}{}
  ...
  \item[\emph{Case} \textsc{E-Nat}:]\
    \begin{array}[t]{ll}
      \pc, \rho_1 |- n \Downarrow n \at pc
      &
      \pc, \rho_2 |- n \Downarrow n \at pc
    \end{array}
  ...
  \item[\emph{Case} \textsc{E-Var}:]\
    \begin{array}[t]{ll}
      ...
      \rho_2(x) = v_2 \at L_2
      \\\hline
      \pc, \rho_1 |- x \Downarrow v_1 \at (\pc \sqcup L_1)
      &
      \pc, \rho_2 |- x \Downarrow v_2 \at (\pc \sqcup L_2)
    \end{array}
    
    By case analysis on $\pc$ and $L_1$,
    using Lemmas~\ref{lem:lp-equiv-lab-inv},~\ref{lem:lp-equiv-raise},
    and~\ref{lem:lp-equiv-l-equiv}.
    
  \item[\emph{Case} \textsc{E-Abs}:]\
    \begin{array}[t]{ll}
      \pc, \rho_1 |- (\lambda{x}.\, e) \Downarrow
      \langle{\rho_1, \lambda{x}.\, e\rangle} \at \pc
      &
      \pc, \rho_2 |- (\lambda{x}.\, e) \Downarrow
      \langle{\rho_2, \lambda{x}.\, e\rangle} \at \pc
    \end{array}
    
    By case analysis on $L$ and $\pc$,
    using Lemma~\ref{lem:lp-equiv-l-equiv}.
  ...
  \item[\emph{Case} \textsc{E-App}:]\
    \begin{array}[t]{ll}
      ...
      \\
      \pc, \rho_1 |- e_2 \Downarrow a_2
      &
      \pc, \rho_2 |- e_2 \Downarrow a_2'
      \\
      L_1, (\rho_1', x_1 = a_2) |- e_1' \Downarrow a_3
      &
      L_2, (\rho_2', x_2 = a_2') |- e_2' \Downarrow a_3'
      \\\hline
      \pc, \rho_1 |- (e_1\ e_2) \Downarrow a_3
      &
      \pc, \rho_2 |- (e_1\ e_2) \Downarrow a_3'
    \end{array}
