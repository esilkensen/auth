...
\begin{definition}
  ...
  atoms for observers at label $L$ and with respect to some predicate $P$,
  where $v_1 \at L_1 \approx^{L}_{P} v_2 \at L_2$ iff either
  \begin{itemize}
  \item
    $L = \bot$ and
  ...
  \end{itemize}
  We write $\approx^{L}$ when $P$ is the everywhere-true predicate.
  \label{def:lp-equiv}
\end{definition}
