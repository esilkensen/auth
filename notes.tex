...
\begin{proof}\renewcommand{\qedsymbol}{}
  ...
  It suffices to show that, for any $n$ such that TODO,
  \begin{flalign}
    & \quad
  ...
  $n = 0$. Assume the claim holds for some $n$ such that TODO. We must show
  that it is true for $\text{TODO} < n + 1$, that is, when $\text{TODO} = n$.
