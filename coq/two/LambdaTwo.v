...
(* ------------------------------------------------------ *)
    [L, P, 0] pc; e ⊢ TNat n ⇓ Atom (VNat n) pc

| E_Var : forall L P pc e n v l,
    atIndex e n = Some (Atom v l) ->
(* ------------------------------------------------------ *)
    [L, P, 0] pc; e ⊢ TVar n ⇓ Atom v (l ⊔ pc)

| E_Abs : forall L P pc e t,
(* ------------------------------------------------------ *)
    [L, P, 0] pc; e ⊢ TLam t ⇓ Atom (VClos e t) pc
